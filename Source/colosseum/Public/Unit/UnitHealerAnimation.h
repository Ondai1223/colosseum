...
#include "UnitHealerAnimation.generated.h"


UENUM(BlueprintType)
enum class EUnitHealerAnimState : uint8
{
 ...
 */
UCLASS()
class COLOSSEUM_API UUnitHealerAnimation : public UUnitAnimInstance
{
	GENERATED_BODY()
...
public:
    ...
    EUnitHealerAnimState  NowAnimState = EUnitHealerAnimState::EUHAS_Idle;  // タンクのアニメーション状態
