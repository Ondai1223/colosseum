...
#include "UnitMagicianAnimation.generated.h"

UENUM(BlueprintType)
enum class EUnitMagicianAnimState : uint8
{
 ...
 */
UCLASS()
class COLOSSEUM_API UUnitMagicianAnimation : public UUnitAnimInstance
{
	GENERATED_BODY()
...
public:
    ...
    EUnitMagicianAnimState  NowAnimState = EUnitMagicianAnimState::EUHAS_Idle;  
